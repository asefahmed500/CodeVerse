...
export function Panel() {
  ...
  // Auto-expand panel when terminal is selected
  useState(() => {
  ...
  return (
    <div
      className={`flex flex-col border-t border-border transition-all duration-200 ease-in-out ${isCollapsed ? "h-8" : "h-64"}`}
    >
      <Tabs value={isTerminalActive ? "terminal" : ""} className="flex flex-col h-full bg-card">
